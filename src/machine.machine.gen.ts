...
export type _AllPaths = {
  machine:
    ...
    | '/preparing/authentication/deleteToken'
    | '/preparing/authentication/session'
    | '/preparing/authentication/authentication'
    ...
    | '/preparing/authentication/authentication/error'
    | '/working'
    | '/working/idle'
    | '/working/save'
    | '/working/autosave'
    | '/working/saving'
    | '/working/saving/local'
    | '/working/saving/internet'
    | '/working/saving/online';
};
/**
 *
